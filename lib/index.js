...
var statusDisplay = {'Power':'ON','Input':'','Lamp':'','Lamp2':''};
var statusUser = {'Power':'ON','Input':''};
...
var Display = function(ip,port,Commands,callback) {
  ...
  this.socket.on('close', function() {
    ...
    console.log(that.port, that.ip)
    setTimeout(function () {
      that.socket.connect(that.port, that.ip)
    }, 9000)
  });
